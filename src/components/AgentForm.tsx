  ...
  return (
    ...
    >
      <Form.Item
        name="name"
        label="Name"
        rules={[{ required: true, message: "Give the sub-agent a name" }]}
      >
      ...
      <Form.Item
        ...
        rules={[{ required: true, message: "Describe what this sub-agent does" }]}
      >
        <Input.TextArea
      ...
      <Form.Item
        ...
        rules={[
          { required: true, message: "Provide instructions (system prompt)" },
        ]}
      >
        <Input.TextArea
